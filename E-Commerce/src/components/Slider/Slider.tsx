  ...
  return (
    <div className="relative pb-4">
      ...
      <div className="flex absolute bottom-12 left-[45%]">
        {sliderData.map((dot: any,index: any) => {
          return (
      ...
      <div>
        <button
          className="absolute top-[50%] right-4  bg-white rounded-full p-2 hover-green"
        ...
        <button
         className="absolute top-[50%] left-4  bg-white rounded-full p-2 hover-green"
